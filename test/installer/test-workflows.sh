...
contains_file "$repo_root/scripts/run-v022-privileged-networking-smoke.sh" 'Denied client network unexpectedly reached' 'v0.2.2 smoke verifies untrusted clients are rejected'
